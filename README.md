# docker-develop-for-go
[Docker](https://www.docker.com/)で[Go](https://go.dev/)開発環境を構築する。
...
## Go versionの設定(Optional)
[.env](./.env)内の`GO_VERSION`を任意の[Go version](https://go.dev/dl/)に設定する。
